    ...
    <section class="body-sign">
        <div class="center-sign">
            <a href="/" class="logo pull-left">
                <img src="assets/images/xc.png" height="54" alt="Porto Admin" />
            </a>
                    ...
                    <form runat="server" id="form1">
                        ...
                        <div class="form-group mb-lg">
                            ...
                            <div class="input-group input-group-icon">
                                <input name="username" runat="server" id="usernameTxt" type="text" class="form-control input-lg" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 4}$" title="Please Type a Valid Email" />
                        ...
                        <div class="form-group mb-lg">
                            ...
                            <div class="input-group input-group-icon">
                                <input name="pwd" runat="server" id="passwordTxt" type="password" class="form-control input-lg" />
                                <span class="input-group-addon">
                                    <span class="icon icon-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-right">
                                <asp:Button runat="server" ID="SignInSubmitBtn1" class="btn btn-primary hidden-xs" OnClick="SignInSubmitBtn_Click1" Text="Sign In"/>
                                <asp:Button runat="server" ID="SignInSubmitBtn" OnClick="SignInSubmitBtn_Click1" CssClass="btn btn-primary btn-block btn-lg visible-xs mt-lg" Text="Sign In" />
                            </div>
                        </div>
