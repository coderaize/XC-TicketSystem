<%@ Page Title="" Language="C#" MasterPageFile="~/Ticket.Master" AutoEventWireup="true" CodeBehind="MyTickets.aspx.cs" Inherits="TicketSystem.MyTickets" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $('#myTicketsBtn').siblings().removeClass('nav-active');
            $('#myTicketsBtn').addClass("nav-active");
            $('#na-tickets-table tfoot th').each(function () {
                var title = $(this).text();
                if (title != '') {
            ...
            var table = $('#na-tickets-table').DataTable({ scrollX: true });
